...
function Team() {
  const teamPpl = [
    { img: Person1, name: "Prabhat Sharma", job: "Salesman" },
    { img: Person2, name: "Samyak Agarwal", job: "Business Owner" },
    { img: Person3, name: "Devanshu Garg", job: "Photographer" },
    { img: Person4, name: "Harshit Chicholikar", job: "Car Detailist" },
    { img: Person5, name: "Abhi Sanghi", job: "Mechanic" },
    { img: Person6, name: "Harshit Tripathi", job: "Manager" },
  ];
  return (
    <>
